...
ggplot() +
  geom_sf(data = ca_counties_raw_sf, fill = "lightgray") +
  geom_point(data = output, aes(x = long, y = lat, color = species), size = 3) +
  scale_color_manual(values = c("blue", "green", "red"), 
                     breaks = c("species1", "species2", "species3"),
                     labels = c("Species 1", "Species 2", "Species 3")) +
  labs(title = "Points by Species") +
  theme_minimal()
```
